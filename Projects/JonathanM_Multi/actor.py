...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, fc3_dims,
            n_actions, name, chkpt_dir='[filename]',agent_name='agent1'):
        ...
        if self.agent_name == 'agent1k' or self.agent_name == 'agent2k' or self.agent_name == 'agent3k' or self.agent_name == 'agent4k':
            ...
            ### a little unfamiliar with what exactly a module list is ###
            ...
            #output_dim1 = self.fc3_dims
            output_dim2 = 5

            ### this creates something like a dictionary of pytorch layers ###
            ### I am not really sure how this works, I got the idea from stackoverflow ###
            ### i needed it because there are a lot of layers in this algorithm ###
    ...
    def forward(self, state, Z1, Z2, Z3, Z4, Z5, Z6, Z7, Z8, A):
        ...
        if self.agent_name == 'agent1k' or self.agent_name == 'agent2k' or self.agent_name == 'agent3k' or self.agent_name == 'agent4k':
            ...
            ### Actor Post-Processing and probability vector generation ###
            ...
            ### Concat outputs (Reason is for ease of use in TD3 learning algorithm)###
